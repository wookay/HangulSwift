...
class HangulInputSystemTests: WHangulTestCase {
    ...
    func test감_ㅁㅏㄱ() {
        let system = HangulInputSystem()
        system.input(종성("ㅁ"))
        Assert.equal("ᅟᅠᆷ", system.text)
        system.input(중성("ㅏ"))
        Assert.equal("ᅟᅡᆷ", system.text)
        system.input(초성("ㄱ"))
        Assert.equal("감", system.text)
    }
    ...
    func test감자() {
        ...
        system.input(종성("ㅁ"))
        Assert.equal("ㅏAᅟᅠᆷ", system.text)
        system.input("B")
        Assert.equal("ㅏAᅟᅠᆷB", system.text)
        system.input(.BACKSPACE)
        Assert.equal("ㅏAᅟᅠᆷ", system.text)
        system.input(.BACKSPACE)
        Assert.equal("ㅏA", system.text)
    ...
    func test실() {
        ...
        d = system.input(종성("ㄹ"))
        Assert.equal("싦ᅟᅠᆯ", system.text)
        Assert.equal("ᅟᅠᆯ", d.change)
        Assert.equal(0, d.n)
    }
    ...
    func test종성() {
        ...
        d = system.input(종성("ㅁ"))
        Assert.equal("ᅟᅠᆷ", system.text)
        Assert.equal("ᅟᅠᆷ", d.change)
        Assert.equal(0, d.n)

        d = system.input(중성("ㅓ"))
        Assert.equal("ᅟᅥᆷ", system.text)
        Assert.equal("ᅟᅥᆷ", d.change)
        Assert.equal(-1, d.n)
    }
    ...
    func test불구경_ㅂㅜㄹㄱㅜㅕㅇㄱ() {
        ...
        d = system.input(중성("ㅜ"))
        d = system.input(종성("ㄹ"))
        Assert.equal("불", system.text)
        
        d = system.input(초성("ㄱ"))
        d = system.input(중성("ㅜ"))
        Assert.equal("불구", system.text)
        Assert.equal(-1, d.n)
        
        d = system.input(중성("ㅕ"))
        Assert.equal("불구ㅕ", system.text)
        Assert.equal(0, d.n)
        
        d = system.input(종성("ㅇ"))
        Assert.equal(-1, d.n)
        Assert.equal("불구ᅟᅧᆼ", system.text)
        
        d = system.input(초성("ㄱ"))
        Assert.equal(-1, d.n)
        Assert.equal("불구경", system.text)
    }
}